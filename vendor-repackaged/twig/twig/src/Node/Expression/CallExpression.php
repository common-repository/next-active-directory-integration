...
use Dreitier\Nadi\Vendor\Twig\TwigCallableInterface;
use Dreitier\Nadi\Vendor\Twig\TwigFilter;
use Dreitier\Nadi\Vendor\Twig\TwigFunction;
use Dreitier\Nadi\Vendor\Twig\TwigTest;
use Dreitier\Nadi\Vendor\Twig\Util\CallableArgumentsExtractor;
use Dreitier\Nadi\Vendor\Twig\Util\ReflectionCallable;
...
abstract class CallExpression extends AbstractExpression
{
    ...
    protected function compileArguments(Compiler $compiler, $isArray = false): void
    {
        ...
        $twigCallable = $this->getAttribute('dreitier_nadi__twig_callable');
    ...
    /**
     * @deprecated since 3.12, use Dreitier\Nadi\Vendor\Twig\Util\CallableArgumentsExtractor::getArguments() instead
     */
    protected function getArguments($callable, $arguments)
    {
        trigger_deprecation('twig/twig', '3.12', 'The "%s()" method is deprecated, use Dreitier\Nadi\Vendor\Twig\Util\CallableArgumentsExtractor::getArguments() instead.', __METHOD__);
        ...
        $isVariadic = $this->getAttribute('dreitier_nadi__twig_callable')->isVariadic();
        if (!$named && !$isVariadic) {
            return $parameters;
        }
    ...
    {
        $current = $this->getAttribute('dreitier_nadi__twig_callable');

        $this->setAttribute('dreitier_nadi__twig_callable', match ($this->getAttribute('type')) {
            'test' => (new TwigTest(
        ...
        return $this->getAttribute('dreitier_nadi__twig_callable');
    }
}
