...
* FIXED: build process for PHP 8.1 with box-project/box environment
...
= 3.1.4 =
* CHANGED: WordPress 6.5 compatibility has been checked
...
= 3.1.1 =
* FIXED: Issue when Sync to WordPress disables non-existing WP user (#191)
